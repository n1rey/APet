  ...
  <div class="album py-5">
    <div class="container">
    	<div style="text-align:right">
		  <a href="/protection/addProtection" class="btn btn-sm btn-outline-warning">임시 보호 글 작성</a>
    	</div><br>
...
<script>
	...
	function pagination(){
		...
		var str = '';
		if (previous) {
	 		  str += "<li class='page-item prev'><a class='page-link' href='/protection/list?page="+ (start - 1) +"'>&laquo; 이전</a></li>";
	 	}
		for(i=start; i<=last; i++){
			str += "<li class='page-item "+ (i==currentPage?'active':'') +"'><a class='page-link' href='/protection/list?page=" + i +"'>"+ i +"</a></li>"
		}
		if (next) {
 		  str += "<li class='page-item next'><a class='page-link' href='/protection/list?page="+ (start + 5) +"'>다음 &raquo;</a></li>"
 		}
